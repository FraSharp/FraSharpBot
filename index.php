...
$Bot->onTextMessage(function (Message $message) {
    ...
    if ($text === "/deleteMessage" and $replyToMessage !== null and $usernameReply !== null) $replyToMessage->delete(null, true);
    ...
    if ($text === "/getUserDc") $chat->sendMessage("@$usernameReply datacenter: " . $userReply->getDC());
